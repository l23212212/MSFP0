...
Nombre del alumno: Diego Macias Armenta
Número de control: 23212212
Correo institucional: l23212212@tectijuana.edu.mx
...
# Colores
clr1 = np.array([149,100,221])/255
clr2 = np.array([255,190,145])/255
clr3 = np.array([118,196,87])/255
